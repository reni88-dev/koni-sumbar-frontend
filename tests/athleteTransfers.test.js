...
import { transferStatusLabel, transferStatusStyle } from '../src/components/athlete-transfers/transferPresentation.js';

test('status transfer atlet menggunakan label Bahasa Indonesia', () => {
