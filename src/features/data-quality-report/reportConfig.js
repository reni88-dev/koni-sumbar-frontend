...
export const QUALITY_REPORTS = [
  {
    ...
    description: 'Lihat kelengkapan data atlet dan pelatih, masalah yang perlu ditangani, serta perkembangannya dari waktu ke waktu.',
  ...
  },
  {
    ...
    description: 'Daftar kualitas profil atlet beserta data yang perlu diperbaiki. Identitas dan kontak ditampilkan sebagian untuk melindungi privasi.',
  ...
  },
  {
    ...
    description: 'Daftar kualitas profil pelatih beserta data yang perlu diperbaiki. Identitas dan kontak ditampilkan sebagian untuk melindungi privasi.',
  ...
  },
  {
    ...
    description: 'Tinjau profil yang memiliki kemiripan identitas atau kontak. Laporan ini tidak menggabungkan atau mengubah data.',
  ...
  },
  {
    ...
    description: 'Periksa NIK, nomor KK, telepon, dan email yang tidak sesuai format. Data pribadi tetap disamarkan.',
  ...
  },
  {
    ...
    description: 'Lihat dokumen yang belum tercatat, tidak ditemukan, atau perlu diperiksa. Perbaikan dilakukan pada data profil.',
