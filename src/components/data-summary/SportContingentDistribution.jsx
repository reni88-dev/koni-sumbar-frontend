          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 max-w-3xl text-sm leading-6 text-slate-500">
                ...
                {formatNumber(Math.max(0, threshold - 1))} kontingen. Perhitungan memakai data atlet SatuData; kontingen adalah kab/kota dari organisasi atlet, sesuai scope dan filter aktif.
              </p>
            </div>
          </div>
      ...
      {!sports.length ? (
        <div className="p-8 text-center sm:p-10">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Belum ada atlet SatuData dengan organisasi kab/kota pada scope dan filter Data Summary saat ini.
          </p>
        </div>
